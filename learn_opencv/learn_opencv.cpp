...
readme:
 ...
 a part of this code
 from CKYF's bilibili and https://zhuanlan.zhihu.com/p/59069810
...
//                for(auto floc=floc_frame.begin();floc<floc_frame.end();floc++){
//                    if(abs(floc-floc)).........
//                }
//            }
  ...
  /*cout<<juxing[1].x<<endl;
    cout<<juxing[1].y<<endl;
    cout<<juxing[2].y<<endl;
    cout<<juxing[3].y<<endl;
    ...
    waitKey(1000);
 cout <<"now,finish it step by step" << endl;
    for(j=1;j<=10;j++){
        for(i=1;i<=7;i++){
            for(j1=1;j1<=10;j1++){
                for(i1=1;i1<=7;i1++){
